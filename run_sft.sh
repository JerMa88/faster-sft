...
#    for m in llama3.2-3b qwen3.5-1.5b gemma4-e4b antares-1b nanbeige4.2-3b lfm2.5-1.2b; do
#        sbatch run_sft.sh "$m"
#    done
# ════════════════════════════════════════════════════════════════════════════
...
case "${MODEL_KEY}" in
  ...
  *)
    ...
    echo "        Valid keys: llama3.2-3b qwen3.5-1.5b gemma4-e4b antares-1b nanbeige4.2-3b lfm2.5-1.2b"
    exit 1
    ;;
esac
