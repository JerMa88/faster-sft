#!/bin/bash
# ════════════════════════════════════════════════════════════════════════════
#  KUG Overhaul Training SLURM Job
#  Usage: sbatch run_kug_train.sh <method> [batch_size] [grad_accum]
#    method: baseline | two_stage | joint
# ════════════════════════════════════════════════════════════════════════════

#SBATCH --job-name=kug_train
...
#SBATCH --output=outputs/logs/kug_train_%x_%j.out
#SBATCH --error=outputs/logs/kug_train_%x_%j.err
...
echo "================================================================"
echo "  Starting KUG Training Job"
echo "  Method: ${METHOD}"
...
${PYTHON} src/training/train_kug_overhaul.py \
    ...
    --output_dir "outputs/kug_overhaul" \
