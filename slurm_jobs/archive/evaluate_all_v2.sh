...
#SBATCH --output=outputs/logs/eval_v2_%j.out
#SBATCH --error=outputs/logs/eval_v2_%j.err
...
/users/jerryma/.conda/envs/torch2.8/bin/python scripts/evaluate_all_v2.py
