#!/bin/bash
# ════════════════════════════════════════════════════════════════════════════
#  KUG 2-Stage RLVR + Knowledge-Circuit Routing (KCR) Training Job
#  Implements Head-Entity Causal Layer Routing (0.1L/0.8L -> 0.5L)
#  from Dai et al. (2025) combined with 2-Step CoT Scratchpad RLVR
#
#  Usage: sbatch run_kug_kcr_rlvr.sh
# ════════════════════════════════════════════════════════════════════════════

#SBATCH --job-name=kug_kcr_rlvr
...
#SBATCH --output=outputs/logs/kug_kcr_rlvr_%j.out
#SBATCH --error=outputs/logs/kug_kcr_rlvr_%j.err
...
LR="${5:-5e-5}"
KCR_WEIGHT="${6:-0.15}"
METHOD="two_stage_kcr_curriculum_rlvr"

echo "================================================================"
echo "  KUG 2-Stage RLVR + Knowledge-Circuit Routing (KCR)"
echo "  Method:        ${METHOD}"
...
echo "Starting RLVR + Knowledge-Circuit Routing (KCR) training on GPU..."
